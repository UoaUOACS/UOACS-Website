...
export const buttonVariants = tv({
  base: "button flex h-6.5 w-fit cursor-pointer flex-row items-center gap-2 rounded-sm px-3 py-1 font-medium transition-colors duration-300 ease-in-out disabled:cursor-not-allowed disabled:brightness-70 disabled:pointer-events-none md:h-8.5",
  variants: {
    theme: {
