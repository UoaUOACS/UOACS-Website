...
export const mockSandfieldSponsor: Sponsor = {
  ...
  logo: {
    ...
    alt: "Sandfield",
    filename: "Logo_Sandfield_GetanEdge_White.a1701b70 1.png",
    mimeType: "image/png",
    filesize: 8467,
    width: 176,
    height: 72,
    ...
    focalY: 50,
    thumbnailURL: null,
    url: "media/Logo_Sandfield_GetanEdge_White.a1701b70%201.png",
...
export const mockJaneStreetSponsor: Sponsor = {
  ...
  logo: {
    ...
    alt: "Jane Street",
    filename: "JaneStreetLogo.670cbc2f 2.png",
    mimeType: "image/png",
    filesize: 6267,
    width: 172,
    height: 72,
    ...
    focalY: 50,
    thumbnailURL: null,
    url: "media/JaneStreetLogo.670cbc2f%202.png",
