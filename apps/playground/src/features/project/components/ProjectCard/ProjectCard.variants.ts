...
export const projectCardVariants = tv({
  slots: {
    base: "font-neulis group relative flex w-full max-w-sm flex-col overflow-hidden rounded-2xl bg-white shadow-sm transition-shadow duration-200 hover:shadow-lg",
    ...
    avatarIcon: "shrink-0 text-gray-500",
    authorName: "truncate text-sm font-semibold text-gray-900",
    statsGroup: "flex shrink-0 items-center gap-3",
    trophyIcon: "shrink-0 text-gray-900",
    likesGroup: "flex items-center gap-1",
    heartIcon: "shrink-0 text-gray-900",
